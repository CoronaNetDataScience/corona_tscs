...
if(run_model) {
  obs_model <- stan_glm(cbind(combined$Difference,floor(combined$state_pop/100) - combined$Difference) ~ I(outbreak_time^2) +
                   I(outbreak_time^3) +
