...
calc_sum %>% 
  ...
  annotate("text",x=ymd(c("2020-04-17","2020-04-17")),
           y=c(max_est+200000,max_obs+200000),
           hjust=1,
           vjust=0,
           fontface="bold",
           size=3,
...
```{r compareids,fig.cap="Comparison Of Time-Varying Covariate Marginal Effects from Partially- and Fully-Identified Models"}
